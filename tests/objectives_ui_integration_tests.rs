...
use focusfive::models::{Config, DailyGoals, OutcomeType, Objective, ObjectiveStatus, FiveYearVision};
...
fn test_objective_navigation_in_selector() -> Result<()> {
    ...
    if let InputMode::ObjectiveSelection { selection_index, .. } = app.input_mode {
