...
fn test_metadata_creation_and_save() -> Result<()> {
    ...
    let goals = DailyGoals {
        ...
        work: Outcome {
            ...
            actions: vec![
                Action { text: "Write code".to_string(), completed: true },
                Action { text: "Write tests".to_string(), completed: false },
                Action { text: "Deploy".to_string(), completed: false },
            ],
            reflection: None,
        },
        health: Outcome {
            ...
            actions: vec![
                ...
                Action { text: "Drink water".to_string(), completed: true },
        ...
        family: Outcome {
            ...
            actions: vec![
                ...
                Action { text: "Plan weekend".to_string(), completed: false },
            ],
            reflection: None,
        },
    };
...
fn test_metadata_reconciliation() -> Result<()> {
    ...
    goals.work.actions = vec![
        Action { text: "Task 1".to_string(), completed: false },
        Action { text: "Task 2".to_string(), completed: false },
        Action { text: "".to_string(), completed: false }, // Empty action (simulating removal)
    ];
    ...
    let health_actions = vec![
        ...
        Action { text: "Task 2".to_string(), completed: false },
        Action { text: "Task 3".to_string(), completed: false },
        Action { text: "Task 4".to_string(), completed: false }, // Added action
    ];
...
fn test_metadata_persistence_across_sessions() -> Result<()> {
    ...
    let goals = DailyGoals {
        ...
        work: Outcome {
            ...
            actions: vec![
                Action { text: "Action 1".to_string(), completed: false },
                Action { text: "Action 2".to_string(), completed: false },
                Action { text: "Action 3".to_string(), completed: false },
            ],
            reflection: None,
        },
        health: Outcome {
...
fn test_metadata_directory_creation() -> Result<()> {
    ...
    let goals = DailyGoals {
        ...
        work: Outcome {
            ...
            goal: None,
            actions: vec![
                Action { text: "".to_string(), completed: false },
                Action { text: "".to_string(), completed: false },
                Action { text: "".to_string(), completed: false },
            ],
            reflection: None,
