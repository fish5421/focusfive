...
use focusfive::data_capture::{
    ActionStatus, DataStorage, Indicator, MeasurementFrequency, Objective, Observation, Review,
    ReviewPeriod,
};
...
fn test_backward_compatibility_with_existing_markdown() -> Result<()> {
    ...
    let goals = DailyGoals {
        ...
        work: Outcome {
            ...
            actions: vec![
                Action {
                    text: "Complete PR review".to_string(),
                    completed: true,
                },
                Action {
        ...
        health: Outcome {
            ...
            actions: vec![
                ...
                Action {
                    text: "Drink 8 glasses water".to_string(),
                    completed: false,
                },
                Action {
                    text: "Sleep before 11pm".to_string(),
                    completed: false,
                },
            ],
            reflection: None,
        ...
        family: Outcome {
            ...
            actions: vec![
                ...
                Action {
                    text: "Plan weekend activity".to_string(),
                    completed: false,
                },
            ],
            reflection: None,
    ...
    let work_actions: Vec<_> = metadata
        .actions
        .iter()
