...
use focusfive::data::{
    load_or_create_day_meta, load_or_create_objectives, save_day_meta, save_objectives, write_goals_file,
};
...
fn test_objective_action_linking() -> Result<()> {
    ...
    let goals = DailyGoals {
        ...
        work: Outcome {
            ...
            actions: vec![
                Action { text: "Write unit tests".to_string(), completed: false },
                Action { text: "Implement core logic".to_string(), completed: false },
                Action { text: "Code review".to_string(), completed: false },
            ],
            reflection: None,
        },
        health: Outcome {
            ...
            actions: vec![
                ...
                Action { text: "Drink water".to_string(), completed: false },
                Action { text: "Sleep early".to_string(), completed: false },
            ],
            reflection: None,
        },
        family: Outcome {
            ...
            goal: None,
            actions: vec![
                Action { text: "Breakfast together".to_string(), completed: true },
                Action { text: "Call parents".to_string(), completed: false },
                Action { text: "Game night".to_string(), completed: false },
            ],
            reflection: None,
        },
    };
...
fn test_multiple_objectives_different_domains() -> Result<()> {
    ...
    let goals = DailyGoals {
        ...
        work: Outcome {
            ...
            goal: None,
            actions: vec![
                Action { text: "Sprint planning".to_string(), completed: false },
                Action { text: "Code review".to_string(), completed: false },
                Action { text: "Documentation".to_string(), completed: false },
            ],
            reflection: None,
        },
        health: Outcome {
            ...
            goal: None,
            actions: vec![
                Action { text: "5K run".to_string(), completed: false },
                Action { text: "Stretching".to_string(), completed: false },
                Action { text: "Meal prep".to_string(), completed: false },
            ],
            reflection: None,
        },
        family: Outcome {
            ...
            goal: None,
            actions: vec![
                Action { text: "Research destinations".to_string(), completed: false },
                Action { text: "Book flights".to_string(), completed: false },
                Action { text: "Plan activities".to_string(), completed: false },
            ],
            reflection: None,
        },
    };
...
fn test_objective_deletion_preserves_metadata() -> Result<()> {
    ...
    let goals = DailyGoals {
        ...
        work: Outcome {
            ...
            goal: None,
            actions: vec![
                Action { text: "Task 1".to_string(), completed: false },
                Action { text: "Task 2".to_string(), completed: false },
                Action { text: "Task 3".to_string(), completed: false },
            ],
            reflection: None,
        },
        health: Outcome {
